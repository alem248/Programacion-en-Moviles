...
/**
 * Servicio encargado de imprimir el cronograma en terminal.
 * Separa la lógica de presentación del dominio (SRP).
 */
class CronogramaService {
    ...
    fun imprimirCronograma(prestamo: Prestamo) {
        ...
        // Encabezado de tabla: N | Fecha Pago | Deuda Actual | Pago Mensual | Deuda Restante
        val linea = "-".repeat(90)
        println(linea)
        println(
            String.format(
                " %-4s | %-12s | %14s | %14s | %14s ",
                "N", "Fecha Pago", "Deuda Actual", "Pago Mensual", "Deuda Restante"
            )
        )
        println(linea)
